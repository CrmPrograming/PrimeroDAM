...
public class Principal {
	...
	/**
	 * Dado un vector de datos y una cantidad, devuelve otro vector
	 * con todos esos datos del mismo tamaño que la cantidad indicada
	 * 
	...
	/**
	 * Método encargado de probar el código donde se utilizan bloques
	 * try-catch a fin de controlar la excepción producida al calcular la media
	 * de una secuencia vacía de valores.
	 */
	public static void tryCatchMedia() {
		...
		try {		
			...
			// Ajustamos el vector reduciendo su tamaño hasta la cantidad de elementos insertada
			...
			System.out.print("! Se produjo un error. ");
			System.out.println("Esperado un valor numérico");
		}
