...
SELECT * FROM contactos WHERE Id_contacto = 15
...
SELECT * FROM contactos WHERE Categoria = 'CUMP' AND deuda > 0
...
SELECT * FROM contactos_copia WHERE Categoria = 'GIMN' OR Categoria = 'CUMP'
...
SELECT * FROM contactos_copia WHERE Categoria = 'GIMN' AND Categoria = 'CUMP'
