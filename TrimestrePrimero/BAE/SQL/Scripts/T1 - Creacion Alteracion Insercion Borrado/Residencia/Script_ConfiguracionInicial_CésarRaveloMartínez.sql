...
IF OBJECT_ID ('dbo.[pk_Estancias]', 'C') IS NULL
	BEGIN
		...
		ALTER TABLE estancias ADD CONSTRAINT fk_Estancias_Estudiante FOREIGN KEY(codEstudiante) REFERENCES estudiantes
		ALTER TABLE estancias ADD CONSTRAINT fk_Estancias_Residencia FOREIGN KEY(codResidencia) REFERENCES residencias
	END
GO